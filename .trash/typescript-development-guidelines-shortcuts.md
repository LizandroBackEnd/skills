...
- React components (exports + file names): PascalCase (e.g. `FeatureCard.tsx` → `FeatureCard`)

- Variables, functions, methods: camelCase

- Files, directories: kebab-case (except React component files, which use PascalCase)

- Constants, env variables: UPPERCASE

- Exception: shadcn/ui under `shared/components/ui/` stays vendor kebab-case
